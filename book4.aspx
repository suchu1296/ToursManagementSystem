<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="book4.aspx.cs" Inherits="book3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p style="background-image: url('Images/sunset.jpg')">
        <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="0" style="z-index: 1; left: 17px; top: 80px; position: absolute; height: 499px; width: 913px" OnFinishButtonClick="Wizard1_FinishButtonClick" OnNextButtonClick="Wizard1_NextButtonClick">
            <WizardSteps>
                <asp:WizardStep runat="server" title="Step 1" StepType="Start">
                    <asp:TextBox ID="TextBox9" runat="server" style="z-index: 1; left: 201px; top: 241px; position: absolute" TextMode="Date"></asp:TextBox>
                    <asp:GridView ID="GridView2" runat="server" DataSourceID="SqlDataSource5" style="z-index: 1; left: 123px; top: 56px; position: absolute; height: 133px; width: 187px">
                    </asp:GridView>
                    <br />
                    <asp:Label ID="Label42" runat="server" style="z-index: 1; left: 82px; top: 199px; position: absolute" Text="Starting Date of selected package is shown here,Select the Date on which you want to travell"></asp:Label>
                    ...
                    <asp:TextBox ID="TextBox1" runat="server" style="z-index: 1; left: 217px; top: 310px; position: absolute" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT DISTINCT [hotel_name] FROM [price1] WHERE (([package no] = @package_no) AND ([hotel] = @hotel))">
                        <SelectParameters>
                            <asp:SessionParameter Name="package_no" SessionField="packageno" Type="Int32" />
                    ...
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" style="z-index: 1; left: 10px; top: 537px; position: absolute" Text="Check Availability and Display Amount" />
                    <br />
                ...
                <asp:WizardStep runat="server" title="Step 2" StepType="Step">
                    ...
                    <asp:Label ID="Label22" runat="server" style="z-index: 1; left: 911px; top: 44px; position: absolute; height: 30px" Text="Enter Bank : "></asp:Label>
                    <asp:Label ID="Label23" runat="server" style="z-index: 1; left: 633px; top: 97px; position: absolute; bottom: 387px;" Text="Enter city"></asp:Label>
                    <asp:TextBox ID="TextBox6" runat="server" style="z-index: 1; left: 957px; top: 48px; position: absolute"></asp:TextBox>
                    <asp:TextBox ID="TextBox7" runat="server" style="z-index: 1; left: 986px; top: 89px; position: absolute"></asp:TextBox>
                    <asp:Label ID="Label24" runat="server" style="z-index: 1; left: 881px; top: 88px; position: absolute; width: 93px;" Text="Enter Bank's Branch : "></asp:Label>
                    ...
                    <asp:TextBox ID="TextBox10" runat="server" style="z-index: 1; left: 695px; top: 97px; position: absolute"></asp:TextBox>
                    <br />
    ...
    <p>
        &nbsp;</p>
    <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [start_date] FROM [tours] WHERE ([package no] = @package_no)">
        <SelectParameters>
            <asp:SessionParameter Name="package_no" SessionField="packageno" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <p>
        &nbsp;</p>
    <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [tours]"></asp:SqlDataSource>
    <p>
        &nbsp;</p>
    <p>
        &nbsp;</p>
